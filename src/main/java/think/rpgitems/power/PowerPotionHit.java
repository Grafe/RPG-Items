...
public class PowerPotionHit extends Power implements PowerHit {
	...
	public String displayText(String locale) {
		return ChatColor.GREEN
				+ String.format(Locale.get("power.potionhit", locale),
						(int) ((1d / (double) chance) * 100d), type.getName()
	...
	public void init(ConfigurationSection s) {
		...
		type = PotionEffectType.getByName(s.getString("type",
				PotionEffectType.HARM.getName()));
	}
