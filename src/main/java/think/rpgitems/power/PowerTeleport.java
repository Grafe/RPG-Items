...
public class PowerTeleport extends Power implements PowerRightClick,
		PowerProjectileHit {
	...
	public void rightClick(Player player) {
		...
		if (cooldown <= System.currentTimeMillis() / 50) {
			...
			// Keeping the old method because BlockIterator could get removed
			// (irc)
	...
	public String displayText(String locale) {
		return ChatColor.GREEN
				+ String.format(Locale.get("power.teleport", locale), distance,
