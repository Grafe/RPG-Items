...
public class PowerHandler implements CommandHandler {
	...
	public void arrow(CommandSender sender, RPGItem item) {
		...
		sender.sendMessage(ChatColor.AQUA
				+ Locale.get("message.power.ok", locale));
	}
	...
	public void command(CommandSender sender, RPGItem item, int cooldown,
			String mouse, String displayText, String command) {
		String locale = sender instanceof Player ? Locale
				.getPlayerLocale((Player) sender) : "en_GB";
	...
	public void command(CommandSender sender, RPGItem item, int cooldown,
			String mouse, String displayText, String command, String permission) {
		String locale = sender instanceof Player ? Locale
				.getPlayerLocale((Player) sender) : "en_GB";
		PowerCommand com = new PowerCommand();
		com.cooldownTime = cooldown;
	...
	public void command(CommandSender sender, RPGItem item, int cooldown,
			String mouse, String details) {
		String locale = sender instanceof Player ? Locale
				.getPlayerLocale((Player) sender) : "en_GB";
		String[] pArgs = details.split("\\|");
		if (pArgs.length < 2) {
			sender.sendMessage(ChatColor.RED
					+ Locale.get("message.error.command.format", locale));
			return;
		}
	...
	@CommandGroup("item_power_knockup")
	public void knockup(CommandSender sender, RPGItem item, int chance,
			double power) {
		String locale = sender instanceof Player ? Locale
				.getPlayerLocale((Player) sender) : "en_GB";
		PowerKnockup pow = new PowerKnockup();
	...
	public void potionhit(CommandSender sender, RPGItem item, int chance,
			int duration, int amplifier, String effect) {
		String locale = sender instanceof Player ? Locale
				.getPlayerLocale((Player) sender) : "en_GB";
		...
		if (pow.type == null) {
			sender.sendMessage(ChatColor.RED
					+ String.format(Locale.get("message.error.effect", locale),
							effect));
			return;
		}
		item.addPower(pow);
	...
	public void potionself(CommandSender sender, RPGItem item, int ccoldown,
			int duration, int amplifier, String effect) {
		String locale = sender instanceof Player ? Locale
				.getPlayerLocale((Player) sender) : "en_GB";
	...
	@CommandGroup("item_power_rainbow")
	public void rainbow(CommandSender sender, RPGItem item, int cooldown,
			int count) {
		String locale = sender instanceof Player ? Locale
				.getPlayerLocale((Player) sender) : "en_GB";
		PowerRainbow pow = new PowerRainbow();
	...
	public void rumble(CommandSender sender, RPGItem item, int cooldown,
			int power, int distance) {
		String locale = sender instanceof Player ? Locale
				.getPlayerLocale((Player) sender) : "en_GB";
	...
	@CommandGroup("item_power_teleport")
	public void teleport(CommandSender sender, RPGItem item, int cooldown,
			int distance) {
		String locale = sender instanceof Player ? Locale
				.getPlayerLocale((Player) sender) : "en_GB";
		PowerTeleport pow = new PowerTeleport();
	...
	public void skyHook(CommandSender sender, RPGItem item, Material material,
			int distance) {
		String locale = sender instanceof Player ? Locale
				.getPlayerLocale((Player) sender) : "en_GB";
	...
	public void potionTick(CommandSender sender, RPGItem item, int amplifier,
			String effect) {
		String locale = sender instanceof Player ? Locale
				.getPlayerLocale((Player) sender) : "en_GB";
